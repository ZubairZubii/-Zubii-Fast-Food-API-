...
def get_order_status(order_id):
    ...
    # Log the order ID being used for the query
    ...
    if result:
        print(f"Order status found: {result[0]}")  # Log the result
        return result[0]
    else:
        print("No order found with the given order_id.")
        return None
